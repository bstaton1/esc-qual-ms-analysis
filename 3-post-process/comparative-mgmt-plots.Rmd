...
PPfiles = out_files[str_detect(out_files, "prob.+\\.rds$")]
...
pp = NULL
meta = list()
for (i in 1:length(mods)) pp = abind(pp, readRDS(file.path(out_dir, PPfiles[i])), along = 6) 
for (i in 1:length(mods)) meta[[i]] = readRDS(file.path(out_dir, metafiles[i])) 
# for (i in 2:length(mods)) PP = abind::abind(PP, readRDS(file.path(out_dir, PPfiles[i])), along = 5) 
# for (i in 2:length(mods)) {cat("\r", i); post[[i]] = readRDS(file.path(out_dir, postfiles[i]))}
...
profile_plot = function(value, desired = "", time, vuln) {
  
  keep = paste0(value, desired)
  sub = pp[,"mean",keep,vuln,time,]
...
mypar = function() {
  par(mfrow = c(1,2), mar = c(3,3,1,1), las = 1, mgp = c(2,0.5,0), tcl = -0.25)
}
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("RMAX", "90p", "early", "unr")
profile_plot("RMAX", "90p", "early", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("RMAX", "90p", "all", "unr")
profile_plot("RMAX", "90p", "all", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("RMAX", "90p", "late", "unr")
profile_plot("RMAX", "90p", "late", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("RMAX", "80p", "early", "unr")
profile_plot("RMAX", "80p", "early", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("RMAX", "80p", "all", "unr")
profile_plot("RMAX", "80p", "all", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("RMAX", "80p", "late", "unr")
profile_plot("RMAX", "80p", "late", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("RMAX", "70p", "early", "unr")
profile_plot("RMAX", "70p", "early", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("RMAX", "70p", "all", "unr")
profile_plot("RMAX", "70p", "all", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("RMAX", "70p", "late", "unr")
profile_plot("RMAX", "70p", "late", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("MSY", "90p", "early", "unr")
profile_plot("MSY", "90p", "early", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("MSY", "90p", "all", "unr")
profile_plot("MSY", "90p", "all", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("MSY", "90p", "late", "unr")
profile_plot("MSY", "90p", "late", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("MSY", "80p", "early", "unr")
profile_plot("MSY", "80p", "early", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("MSY", "80p", "all", "unr")
profile_plot("MSY", "80p", "all", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("MSY", "80p", "late", "unr")
profile_plot("MSY", "80p", "late", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("MSY", "70p", "early", "unr")
profile_plot("MSY", "70p", "early", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("MSY", "70p", "all", "unr")
profile_plot("MSY", "70p", "all", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("MSY", "70p", "late", "unr")
profile_plot("MSY", "70p", "late", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("H", "100k", "early", "unr")
profile_plot("H", "100k", "early", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("H", "100k", "all", "unr")
profile_plot("H", "100k", "all", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("H", "100k", "late", "unr")
profile_plot("H", "100k", "late", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("H", "90k", "early", "unr")
profile_plot("H", "90k", "early", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("H", "90k", "all", "unr")
profile_plot("H", "90k", "all", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("H", "90k", "late", "unr")
profile_plot("H", "90k", "late", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("H", "80k", "early", "unr")
profile_plot("H", "80k", "early", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("H", "80k", "all", "unr")
profile_plot("H", "80k", "all", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("H", "80k", "late", "unr")
profile_plot("H", "80k", "late", "res")
```

### >70K {.tabset .tabset-fade .tabset-pills}

#### First 10 Years

```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("H", "70k", "early", "unr")
profile_plot("H", "70k", "early", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("H", "70k", "all", "unr")
profile_plot("H", "70k", "all", "res")
```
...
```{r, fig.height = 4, fig.width = 8, eval = pp_eval}
mypar()
profile_plot("H", "70k", "late", "unr")
profile_plot("H", "70k", "late", "res")
```
