...
diag_plots(post, "delta_0", show_diags = "never", thin_percent = diag_plot_thin)
```
...
diag_plots(post, "delta_1", show_diags = "never", thin_percent = diag_plot_thin)
```
...
diag_plots(post, "gamma_0", show_diags = "never", thin_percent = diag_plot_thin)
```
...
diag_plots(post, "gamma_1", show_diags = "never", thin_percent = diag_plot_thin)
```
