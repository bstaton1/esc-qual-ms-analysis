...
title: "`r paste('Detailed Output for Model', model_ids[model], sep = ': ')`"
...
`r if (sra & meta$z_unit == "fish_count") "Because this model treats one psawner as the unit of reproductive contribution Z and S are the same."`
...
if (meta$z_unit != "fish_count") {
  arrows(Z[Z_ind], R[3,R_ind], S[Z_ind], R[3,R_ind], code = 1, length = 0.05)
...
`r cntr = up_cntr("Figure", cntr, per_cap); create_label("Figure", cntr, T, level = 2, sub = "b", subb = "", text = "Per Female Spawner", tabset = F, per_cap & meta$z_unit != "fish_count")`
