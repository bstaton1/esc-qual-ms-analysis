---
title: "`r paste0('Online Supplement S', m + 1, ' to Staton et al.')`"
...
`r if (mcmc_info & diag_plot_thin > 0) paste0("**NOTE:** The posterior samples were thinned by an additional S", diag_plot_thin * 100, "% for traceplotting (but not for any other content).")`
...
edit_full_model(
  ...
  outfile = "", len_trend = meta$len_trend, age_trend = meta$age_trend, sex_trend = meta$sex_trend, z_unit = meta$z_unit,
