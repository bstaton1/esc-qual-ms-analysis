...
Red points represent the aggregate exploitation rate based on observed data: total catch (subsistence + escapement) divided by total catch + total escapement.
