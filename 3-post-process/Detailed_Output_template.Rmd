...
par(mfcol = c(4,2), mar = c(1,2,2,1.5), oma = c(3,4,0,0), cex.main = 1.4, cex.axis = 1.4, mpg = c(2,0.4,0), tcl = -0.2)
sex = rep(c("Females", "Males"), each = na)
age_v = rep(a_min:a_max, 2)
for (as in 1:8) {
  plot(q_fit[,as] ~ years, type = "n", ylim = range(c(q_lwr[,as], q_upr[,as], q_obs[,as]), na.rm = T),
...
par(mar = c(2,3,2,2), cex.main = 1.4, mgp = c(2,0.4,0), tcl = -0.2)
...
par(mfcol = c(4,1), mar = c(2,2,2,2), oma = c(0,3,0,0), cex.main = 1.4, cex.axis = 1.4, mgp = c(2,0.4,0), tcl = -0.2)
...
par(mfcol = c(4,2), mar = c(2,2,2,2), oma = c(0,3,0,0), cex.main = 1.4, tcl = -0.2, mgp = c(2,0.4,0))
