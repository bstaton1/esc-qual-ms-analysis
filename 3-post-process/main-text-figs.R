...
par(mar = c(2,2.25,2,0.5), mgp = c(1.25,0.2,0), tcl = -0.15, cex.axis = 0.75, lend = "square", cex.lab = 1)
...
mtext(side = 3, "METF (mm) w/6 in. Mesh", line = 1, col = "grey60", font = 1, cex = 1)
segments(par("usr")[1], par("usr")[4], par("usr")[2], par("usr")[4],col = "grey60", xpd = T)
mtext(side = 1, "METF (mm) w/8 in. Mesh", line = 1.2, font = 1, cex = 1)
