...
# Section #5: Between-Model Fit to Composition Data
...
**Figure 5.2** Bayesian $p$-values for 5 models from the main-text analysis for each fate-specific data set: (a) escapement, (b) subsistence harvest, and (c) commercial harvest. Values close to 0.5 (horizontal dashed line) indicate better model adequacy according to the $\chi^2$ fit measure.
